        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(" 😈 ¦ المـطوريـن", url=f"https://t.me/Gaaaamd","https://t.me/L_U_C_E_F_R")
                ],
            ]
        ),
...
async def alive(client: Client, message: Message):
    ...
    await message.reply_photo(
        photo=f"https://telegra.ph/file/9db28e7ef3ef756525eb4.jpg",
        caption=alive,
...
━━━━━━━━━━━━━━
  ⚡️ ??قناة البوت @Gaamd_23""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("𝆥 𝑴𝒚_𝑷𝒚𝒕𝑯𝒐𝒏_𝑩𝒐𝑻 ›", url=f"https://t.me/Gaamd_23"),
                ],
            ]
        ),
    )
