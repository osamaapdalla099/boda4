...
@Client.on_message(command(["/mplay","شغيل","شغيل اغنيه","/play","شغل","بودا","لوسيفر","تشغيل","ش", f"/mplay@{BOT_USERNAME}"]) & other_filters)
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
              ...
              [InlineKeyboardButton("𝙎𝙊𝙐𝙍𝘾𝙀 𝑩𝑶𝑫𝑨𖡛“.", url=f"https://t.me/Gaamd_23"),
                ],
